...
codes = [{"code":"7130AB","system":"readv2"},{"code":"N050600","system":"readv2"},{"code":"7130N","system":"readv2"},{"code":"7130MD","system":"readv2"},{"code":"7130B","system":"readv2"},{"code":"7130H","system":"readv2"},{"code":"7131A","system":"readv2"},{"code":"7130D","system":"readv2"},{"code":"7130FT","system":"readv2"}];
REQUIRED_CODES = 1;
